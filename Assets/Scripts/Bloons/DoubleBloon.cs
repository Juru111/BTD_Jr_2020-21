...
{   
    ...
    public override void LayerPop(int power, GameObject parentPopProjectle)
    {
        ...
        GameBox.instance.poolingMenager.SummonBloon(newBloonName, layersLeft - power, anotherBloonPosition, myNextWaypoint, distanceToWaypoint + spacing, isCammo, stunDurationLeft, parentPopProjectles);
